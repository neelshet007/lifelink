      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-4xl relative z-10 flex flex-col items-center mb-8">
        <Link href="/" className="flex items-center gap-3 mb-5">
          <div className="flex items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 shadow-sm">
            ...
            <Activity className="h-6 w-6 text-[#ffbf73]" />
          </div>
        </Link>
        <p className="text-xs uppercase tracking-[0.34em] text-[#ff8f1f]">Government Modern Access</p>
        <h2 className="mt-4 text-center text-4xl font-semibold text-slate-900">
          National Health Gateway for <span className="text-[#0b4ea2]">LifeLink</span>
        </h2>
        <p className="mt-4 max-w-2xl text-center text-sm leading-6 text-slate-600">
          One verified entry point for ABHA citizens, HFR facilities, and DCGI-verified blood banks.
        </p>
      </div>
